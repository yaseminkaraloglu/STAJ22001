...
namespace yktest
{
    public class Startup
    {
        ...
        app.UseScheduler((o) => o.Id = SchedulerHelper.GetDefaultSchedulerName("yktest"));
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"asset")),
            RequestPath = new PathString("/apps/yktest/latest/asset")
            });
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"dist")),
            RequestPath = new PathString("/apps/yktest/latest/dist")
            });
            ...
            // app.UseSwaggerUI(c =>
            // {
        //     c.SwaggerEndpoint("v1/swagger.json", "Bimser.Synergy.yktest.API.Swagger v1");
