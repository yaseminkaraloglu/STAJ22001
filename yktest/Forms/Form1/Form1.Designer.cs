...
using yktest.Entities;

namespace yktest.Forms {

    public partial class Form1 : Form<E_yktest_Form1Entity> {
...
DateTimePicker DateTimePicker4 { get; set; }
Section Section1 { get; set; }
Section Section3 { get; set; }
MaskInput MaskInput1 { get; set; }
...
Column6 = new Column {
ControlId = "14846b2f-59ab-4fe7-84fe-30854a74a066",
Name = "Column6",
...
Header1 = new Header {
ControlId = "edbaa4ff-b03b-2ff9-a6f2-c5f6e1f147ee",
Name = "Header1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Yıllık İzin Talebi Formu" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Yıllık İzin Talebi Formu" },{ "en-US", "Header1" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
ControlId = "5fb735fd-f20b-76a1-22c3-4f1e3fc041de",
...
ControlId = "08d52e49-65fa-1c05-61e7-ec19898f1b1b",
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "İzin Başlangıç Tarihi" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
ControlId = "b4fedb78-fdef-f257-accd-11cb6e28947e",
...
ControlId = "f13c8dde-1732-6ef4-1f66-25f2e003ddd0",
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "İşe Dönüş Tarihi" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
BaseComponent default_datetimepicker4Component = new BaseComponent {
Id = "DateTimePicker4",
Type = "DateTimePicker",
ParentId = "Column5",
DesignerProps = new DesignerProps {
...
Properties = DateTimePicker4,
ViewProperties = "",
};

AddToViewItems("default", default_datetimepicker4Component);

Section1 = new Section {
ControlId = "8e7598af-cb49-484d-8800-b6f487cd46de",
Name = "Section1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
ClientVisible = true;
ProjectName = "yktest";
ProjectId = "21cded6f-7854-4a88-bb22-47dfd7703e41";
EntityPath = "";
ActiveView = "default";
Version = 19;
ReadOnly = false;
...
Name = "Form1";
FormId = "57377e96-c08e-4781-a4d3-76ad34968b55";
...
ControlId = "166f81c9-ebe0-4c0e-b024-0843ab03256a",
Name = "Section3",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
MaskInput1 = new MaskInput {
ControlId = "7d2f626b-33c2-a214-5dec-7c264e7c5640",
Name = "MaskInput1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "İletişim numarası" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(MaskInput1);

BaseComponent default_maskinput1Component = new BaseComponent {
Id = "MaskInput1",
Type = "MaskInput",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = MaskInput1,
ViewProperties = "",
};

AddToViewItems("default", default_maskinput1Component);

ComboBox1 = new ComboBox {
ControlId = "7ad6152b-7d20-953a-21aa-624cf8370149",
Name = "ComboBox1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Vekalet Eden Kullanıcı" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
ControlId = "81dba66a-58e9-0c79-add3-30e96204b12e",
Name = "UserMetadata1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
ControlId = "0f286ffd-4aa0-2a36-06d2-ec86a846efc8",
Name = "TextArea1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
AddToViewItems("default", default_textarea1Component);

UserMetadata2 = new UserMetadata {
ControlId = "718d6875-a4b6-34c7-51de-05097378a90c",
Name = "UserMetadata2",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Column1 = new Column {
ControlId = "2abeb55b-0ddc-41cf-b380-ee84d5adf518",
Name = "Column1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
ControlId = "ef4f4a48-191f-6759-2011-61accdc7cde9",
Name = "InputGroup1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Label1 = new Label {
ControlId = "5baeaa6b-a292-51e6-5be0-1f45dd552248",
Name = "Label1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Label2 = new Label {
ControlId = "c7e46c0a-bfab-740f-befa-e18dd0ec85a3",
Name = "Label2",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Column5 = new Column {
ControlId = "8c6c6a99-5d5f-473d-8082-168dd3d02d9a",
Name = "Column5",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Label3 = new Label {
ControlId = "01bb2663-6d63-ca70-f625-9135d687a69b",
Name = "Label3",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "İzin Bilgileri" },{ "en-US", "Label3" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
