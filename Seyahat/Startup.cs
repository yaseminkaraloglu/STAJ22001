...
namespace Seyahat
{
    public class Startup
    {
        ...
        app.UseScheduler((o) => o.Id = SchedulerHelper.GetDefaultSchedulerName("Seyahat"));
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"asset")),
            RequestPath = new PathString("/apps/Seyahat/latest/asset")
            });
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"dist")),
            RequestPath = new PathString("/apps/Seyahat/latest/dist")
            });
            ...
            // app.UseSwaggerUI(c =>
            // {
        //     c.SwaggerEndpoint("v1/swagger.json", "Bimser.Synergy.Seyahat.API.Swagger v1");
