...
namespace MasrafBeyanFormu
{
    public class Startup
    {
        ...
        app.UseScheduler((o) => o.Id = SchedulerHelper.GetDefaultSchedulerName("MasrafBeyanFormu"));
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"asset")),
            RequestPath = new PathString("/apps/MasrafBeyanFormu/latest/asset")
            });
            ...
            {
                FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"dist")),
            RequestPath = new PathString("/apps/MasrafBeyanFormu/latest/dist")
            });
            ...
            // app.UseSwaggerUI(c =>
            // {
        //     c.SwaggerEndpoint("v1/swagger.json", "Bimser.Synergy.MasrafBeyanFormu.API.Swagger v1");
